...
try {
  ...
  if (result && result.choices[0]?.message?.content) {
    ...
    console.log('\n\n***CHAT_HELPER.JS: Is the response from chatGPT including one of the [bot_response] patterns?', bot_response_patterns.some(pattern => result.choices[0].message.content.includes(pattern)));
